    ...
    return ( 
        <div className='container mt-5'>
            ...
            <div className='row p-5' >
                ...
                <div className='col-4'>
                    <p style={{fontSize:"20px",fontWeight:"revert",paddingLeft:"40px"}}>Your zerodha Account</p>
                ...
                <div className='col-4'>
                    <p style={{fontSize:"20px",fontWeight:"revert",paddingLeft:"40px"}}>Your zerosha Account</p>
